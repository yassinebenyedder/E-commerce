...
const Promotion = require('./src/models/Promotion.ts').default;
const Order = require('./src/models/Order.ts').default;
const Category = require('./src/models/Category.ts').default;
...
// Sample Orders Data (will be generated after products are created)
async function generateSampleOrders(products) {
  const sampleOrders = [
    {
...
async function seedDatabase() {
  try {
    ...
    // Create orders (using created product IDs)
    console.log('📋 Creating orders...');
    const orderData = await generateSampleOrders(products);
